                ...
                <div class="menu-block">
                    ...
                    <div class="menu-wrap">
                        <ul class="header__ul flex1 flex-full">
                            <li>
                                <a href="{{ route('work') }}#b02" class="fz17 link link-dark fw500" data-link="#b02">О сервисе</a>
                            </li>
                            <li>
                                <a href="{{ route('work') }}#b03" class="fz17 link link-dark fw500" data-link="#b03">Как работает</a>
                            </li>
                            <li>
                                <a href="{{ route('work') }}#b04" class="fz17 link link-dark fw500" data-link="#b04">Отзывы</a>
                            </li>
                            <li>
                                <a href="{{ route('work') }}#b05" class="fz17 link link-dark fw500" data-link="#b05">Частые
                                    вопросы</a>
                            </li>
                            <li>
