            ...
            <div class="white-bg al-b02 mb180">
                <div class="flex">
                    ...
                    <div class="col8 col12-550 al-b02__right">
                        <p class="fz20 mb20">Часовой пояс - {{ config('app.timezone_txt') }} (текущее время <span class="fw600 color-green">{{ (new \Carbon\Carbon())->format('d.m.Y, H:i')}}</span>)</p>
                        <form-user-schedule></form-user-schedule>
                    </div>
                </div>
            </div>
        </div>
