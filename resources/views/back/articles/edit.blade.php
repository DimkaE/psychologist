    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card mb-3">
                    <form
                        action="{{ $item ? route('back.articles.update', ['article' => $item->id]) : route('back.articles.store') }}"
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    <td>Аватар</td>
                                    <td>
                                        @if($item && $item->thumb_small)
                                            <img src="{{ url($item->thumb_small) }}" alt="">
                ...
                @if($item)
                    <div class="card">
                        ...
                        <div class="card-body alert-danger">
                            ...
                            <form method="post" action="{{ route('back.articles.destroy',  ['article' => $item->id]) }}"
                                  style="display: none;">
                                @csrf
                                @method('DELETE')
