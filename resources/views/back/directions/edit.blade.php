...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card mb-3">
                    <form action="{{ $item ? route('back.directions.update', ['direction' => $item->id]) : route('back.directions.store') }}" method="post" enctype="multipart/form-data" class="js-form-send">
                    <div class="card-header">
                        @if($item)
                            <h4>Редактировать направление</h4>
                        @else
                ...
                @if($item)
                    <div class="card">
                        ...
                        <div class="card-body alert-danger">
                            ...
                            <form method="post" action="{{ route('back.directions.destroy',  ['direction' => $item->id]) }}" style="display: none;">
                                @csrf
                                @method('DELETE')
