            ...
            <div class="col-md-12">
                <table class="table table-striped table-bordered table-sm table-hover">
                    <tr class="t_header">
                        ...
                        <th><a href="users.email"
                               @if($request->sort_col == 'users.email' ) class="{{ $request->sort_dir }}" @endif>Email</a></th>
                    ...
                    <tr class="filters">
                        ...
                        <th>
                            <input type="text" name="filter_like[users.email]" class="form-control"
                                   value="{{ $request->filter_like['users.email'] ?? '' }}">
                        </th>
                    ...
                    @foreach($items as $item)
                        <tr>
                            <td>
                                <a href="{{ route('back.payments.show', ['payment' => $item->id]) }}"
