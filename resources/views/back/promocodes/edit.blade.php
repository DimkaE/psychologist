    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card mb-3">
                    <form
                        action="{{ $item ? route('back.promocodes.update', ['promocode' => $item->id]) : route('back.promocodes.store') }}"
                        method="post" enctype="multipart/form-data" class="js-form-send">
                        <div class="card-header">
                            @if($item)
                                <h4>Редактировать промокод</h4>
                            @else
                ...
                @if($item)
                    <div class="card">
                        ...
                        <div class="card-body alert-danger">
                            ...
                            <form method="post"
                                  action="{{ route('back.promocodes.destroy',  ['promocode' => $item->id]) }}"
                                  style="display: none;">
                                @csrf
                                @method('DELETE')
